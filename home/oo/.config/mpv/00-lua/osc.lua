...
local user_opts = {
    ...
    scalewindowed = 4,          -- scaling of the controller when windowed
    scalefullscreen = 4,        -- scaling of the controller when fullscreen
    scaleforcedwindow = 4,      -- scaling when rendered on a forced window

    minmousemove = 0,           -- minimum amount of pixels the mouse has to move between ticks to make the OSC show up
    deadzonesize = 0.5,         -- size of deadzone
    hidetimeout = 2000,         -- duration in ms until the OSC hides if no mouse movement.
    fadeduration = 200,         -- duration of fade out in ms, 0 = no fade

    layout = "box",
    seekbarstyle = "bar",       -- bar, diamond or knob
    boxalpha = 100,             -- alpha of the background box,
    seekrangealpha = 100,       -- transparency of seekranges

    seekbarhandlesize = 0.5,    -- size ratio of the diamond and knob handle
    barmargin = 0,              -- vertical margin of top/bottombar
    valign = 0,                 -- vertical alignment, -1 (top) to 1 (bottom)
    ...
    rjno1title = "MPV- ${filename}", --用来修改显示-口x时的标题
